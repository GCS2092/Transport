...
export const T = {
  fr: {
    ...
    form: {
      ...
      scheduleSectionTitle: 'Planning du trajet',
      scheduleAllerHint: 'Aller — indiquez quand vous souhaitez être pris en charge au départ.',
      scheduleAllerSimpleExtra: 'L’heure correspond au départ vers votre destination (ex. vol, rendez-vous).',
      scheduleRetourSimpleExtra: 'Heure à laquelle vous devez être récupéré (ex. à l’aéroport ou au lieu de départ du retour).',
      scheduleRetourTitle: 'Retour — prise en charge pour le trajet de retour',
      scheduleRetourHint: 'Indiquez quand le chauffeur doit vous récupérer pour le retour (après votre vol ou votre rendez-vous).',
      scheduleRoundTripExplain: 'Deux créneaux : un pour l’aller, un pour le retour. Vous pouvez préciser les horaires de vol plus bas pour un meilleur alignement.',
      ...
      interurbanDetails: 'Vos coordonnées',
      interurbanDetailsHint: 'Pour votre course interurbaine, indiquez vos coordonnées. L\'email est facultatif — le suivi se fait via votre code de réservation.',
      firstName: 'Prénom', lastName: 'Nom',
      emailField: 'Adresse email', emailOptional: 'Adresse email (optionnel)', phoneField: 'Téléphone',
      ...
      successNoEmail: 'Votre réservation est enregistrée. Suivez-la sur la page Suivi avec votre code.',
      successInterurbanHint: 'Le tarif vous sera communiqué dans votre inbox sur la page Suivi.',
      cancelTokenTitle: "Code d'annulation",
      cancelTokenHint: 'Conservez ce code pour annuler votre réservation depuis la page Suivi.',
      ...
      selectZones: 'Veuillez renseigner le lieu de départ et d\'arrivée',
      selectPickupLocation: 'Veuillez renseigner le lieu de départ',
      selectDropoffLocation: 'Veuillez renseigner le lieu d\'arrivée',
      gpsLoading: 'Localisation GPS en cours, veuillez patienter…',
      searchAddress: 'Rechercher une adresse ou zone…',
      differentZones: 'Le départ et l\'arrivée doivent être différents',
  ...
  en: {
    ...
    form: {
      ...
      scheduleSectionTitle: 'Trip schedule',
      scheduleAllerHint: 'Outbound — when you want to be picked up.',
      scheduleAllerSimpleExtra: 'This is your departure pickup time toward your destination.',
      scheduleRetourSimpleExtra: 'When you need to be picked up (e.g. at the airport).',
      scheduleRetourTitle: 'Return — pickup for the return leg',
      scheduleRetourHint: 'When the driver should pick you up for the return trip.',
      scheduleRoundTripExplain: 'Two slots: outbound pickup and return pickup. Add flight times below if useful.',
      ...
      interurbanDetails: 'Your contact details',
      interurbanDetailsHint: 'For your interurban trip, enter your contact details. Email is optional — track your booking with your reservation code.',
      firstName: 'First name', lastName: 'Last name',
      emailField: 'Email address', emailOptional: 'Email address (optional)', phoneField: 'Phone',
      ...
      successNoEmail: 'Your booking is recorded. Track it on the Tracking page with your code.',
      successInterurbanHint: 'The price will be communicated in your inbox on the Tracking page.',
      cancelTokenTitle: 'Cancellation code',
      cancelTokenHint: 'Keep this code to cancel your booking from the Tracking page.',
      bookingCode: 'Booking code',
      keepCode: 'Keep this code to track and manage your booking',
      trackBooking: 'Track my booking', newBooking: 'New booking',
      selectZones: 'Please enter departure and arrival locations',
      selectPickupLocation: 'Please enter a departure location',
      selectDropoffLocation: 'Please enter an arrival location',
      gpsLoading: 'GPS locating in progress, please wait…',
      searchAddress: 'Search for an address or zone…',
      differentZones: 'Departure and arrival must be different',
